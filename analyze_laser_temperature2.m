...
fitResults = table('Size', [0, 9], ...
    ...
    'VariableNames', {'TestLevel', 'LaserChannel', 'Slope', 'Intercept', ...
        'Correlation', 'ResidualStd', 'RMSE', 'ResidualMin', 'ResidualMax'});

incrementCurves = table('Size', [0, 6], ...
    'VariableTypes', {'double', 'string', 'double', 'double', 'double', 'double'}, ...
    'VariableNames', {'TestLevel', 'LaserChannel', 'BaselineTemperature', ...
        'BaselineReading', 'DeltaTemperature', 'DeltaReading'});
